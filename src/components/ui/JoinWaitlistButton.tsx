...
export function JoinWaitlistButton({
    ...
    return (
        ...
        >
            {children || (
                <div className="flex flex-row justify-center items-center gap-[6.23vw] mobile:gap-[1.23vw]">
                    <span
                        className="text-white font-medium text-[4.22vw] mobile:text-[1.03vw] leading-[5.88vw] mobile:leading-[2.25vw] tracking-[0.03em] mobile:tracking-normal whitespace-nowrap"
                    >
                        {text}
                    </span>
                    {showIcon && (
                        <div className="relative w-[3.5vw] h-[3.5vw] mobile:w-[0.74vw] mobile:h-[0.74vw] mobile:px-[0.2vw]">
                            <Image
