        ...
        >
            ...
            <div className="flex flex-col mobile:flex-row justify-center items-start lg:items-stretch lg:flex-row p-0 gap-[5.45vw] mobile:gap-[3.75vw] lg:gap-[4.17vw] w-full max-w-full mobile:max-w-full lg:max-w-none lg:w-full">
                ...
                <div className="flex flex-col items-start p-0 gap-[5.45vw] mobile:gap-[1.87vw] lg:gap-[2.08vw] w-full mobile:w-[35.7vw] lg:w-[40vw] mobile:h-auto lg:h-auto flex-none order-1">
                    <h2
                        className="w-full text-white text-[4.54vw] lg:text-[1.67vw] font-bold flex items-center tracking-normal leading-[120%]"
                    >
                        <span className="block mobile:hidden">About Us</span>
                        <span className="hidden mobile:block mobile:text-[1.45vw]">About Us</span>
                    </h2>
                    <h1
                        className="w-full text-white text-[6.36vw] lg:text-[3.33vw] font-bold flex items-center tracking-normal leading-[110%]"
                    >
                    ...
                    <div className="flex flex-col gap-[5.45vw] mobile:gap-[0.9vw] lg:gap-[2.08vw]">
                        <p
                            className="w-full text-[#CCCCCC] text-[4.09vw] lg:text-[1.25vw] font-normal flex items-center tracking-normal mobile:leading-[177%] lg:leading-[120%]"
                        >
                            <span className="block tracking-normal mobile:hidden">Most social apps focus on individuals. But in the real world, friendships, adventures, and unforgettable memories often start with a group.</span>
                            <span className="hidden tracking-normal mobile:block mobile:text-[1.11vw] mobile:leading-[120%] mobile:tracking-tighter">Most social apps focus on individuals. But in the real world, friendships, adventures, and unforgettable memories often start with a group.</span>
                        </p>
                        <p
                            className="w-full text-[#CCCCCC] text-[4.09vw] lg:text-[1.25vw] font-normal flex items-center tracking-normal mobile:leading-[177%] lg:leading-[120%]"
                        >
                            <span className="block tracking-normal mobile:hidden">Fennec makes it effortless for groups to find their people, match with the right vibes, and create experiences that actually feel real.</span>
                            <span className="hidden tracking-normal mobile:block mobile:text-[1.11vw] mobile:leading-[120%] mobile:tracking-tighter">Fennec makes it effortless for groups to find their people, match with the right vibes, and create experiences that actually feel real.</span>
                        </p>
                        <p
                            className="w-full text-[#CCCCCC] text-[4.09vw] lg:text-[1.25vw] font-normal flex items-center tracking-normal mobile:leading-[177%] lg:leading-[120%]"
                        >
                            ...
                            <span className="hidden mobile:block mobile:text-[1.11vw] mobile:leading-[120%] mobile:tracking-tighter">Whether you&apos;re new in town, building your circle, or simply looking to meet like-minded friends, we&apos;re here to make connecting easier, safer, and more fun.</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col mobile:flex-row justify-center items-start lg:items-stretch lg:flex-row p-0 gap-[5.45vw] mobile:gap-[3.75vw] lg:gap-[4.17vw] w-full max-w-full mobile:max-w-[75.2vw] lg:max-w-none lg:w-full">
                ...
                <div className="flex flex-col items-start p-[5.45vw] mobile:p-[1.87vw] lg:p-[2.08vw] gap-[5.45vw] mobile:gap-[1.87vw] lg:gap-[2.08vw] w-full mobile:w-[35.7vw] lg:w-[40vw] mobile:h-auto lg:h-auto bg-[#5F00DB] rounded-[3.63vw] mobile:rounded-[1.87vw] lg:rounded-[2.08vw] flex-none order-1 mobile:order-0">
                    ...
                    <h3
                        className="w-full text-white text-[6.36vw] lg:text-[2.5vw] font-bold flex items-center tracking-normal leading-[110%]"
                    >
                    ...
                    <div className="flex flex-col gap-[5.45vw] mobile:gap-[0.9vw] lg:gap-[2.08vw]">
                        ...
                        >
                            ...
                            <span className="hidden mobile:block mobile:text-[1.11vw] mobile:leading-[120%] mobile:tracking-normal">We believe friendship shouldn&apos;t feel like work. Fennec removes the pressure, awkwardness, and randomness from meeting new people — and instead make it a natural extension of your everyday social life.</span>
                        </p>
                        <p
                            className="w-full text-[#CCCCCC] text-[4.09vw] lg:text-[1.25vw] font-normal flex items-center tracking-normal mobile:leading-[177%] lg:leading-[120%]"
                        >
                            ...
                            <span className="hidden mobile:block mobile:text-[1.11vw] mobile:leading-[120%] mobile:tracking-normal">We&apos;re here to build a space where groups discover groups, where vibes match effortlessly, and where connections evolve into real-life stories.</span>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-col items-start p-[5.45vw] mobile:p-[1.87vw] lg:p-[2.08vw] gap-[5.45vw] mobile:gap-[1.87vw] lg:gap-[2.08vw] w-full mobile:w-[35.7vw] lg:w-[40vw] mobile:h-auto lg:h-auto bg-[#16003F] rounded-[3.63vw] mobile:rounded-[1.87vw] lg:rounded-[2.08vw] flex-none order-1">
                    ...
                    <div className="flex flex-col gap-[5.45vw] mobile:gap-[0.9vw] lg:gap-[2.08vw]">
                        ...
                        >
                            ...
                            <span className="hidden mobile:block mobile:text-[1.11vw] mobile:leading-[120%] mobile:tracking-normal">We envision a future where nobody feels isolated in a new city, where social circles expand seamlessly, and where meeting new people happens with confidence, trust, and genuine compatibility.</span>
                        </p>
                        <p
                            className="w-full text-[#CCCCCC] text-[4.09vw] lg:text-[1.25vw] font-normal flex items-center tracking-normal mobile:leading-[177%] lg:leading-[120%]"
                        >
                            ...
                            <span className="hidden mobile:block mobile:text-[1.11vw] mobile:leading-[120%] mobile:tracking-normal">Our vision is to become the global platform that powers real-world group connections — for friendships, events, adventures, creativity, and everything in between.</span>
                        </p>
                    </div>
                </div>
            </div>
