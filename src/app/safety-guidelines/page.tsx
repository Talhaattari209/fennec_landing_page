    ...
    },
    {
        ...
        description: (
            <div className="flex flex-col gap-[0.83vw]">
                <p className="font-normal text-[0.94vw] leading-[1.78] text-[#CCCCCC]">
                ...
                <ul className="flex flex-col gap-[0.83vw]">
                    {[
                        ...
                        <li key={index} className="flex items-start gap-[0.625vw] ml-[0.83vw]">
                            <span className="text-[#CCCCCC] mt-[0.31vw] leading-[1]">•</span>
                            <span className="font-normal text-[0.94vw] leading-[1.78] text-[#CCCCCC]">
                                {text}
                            </span>
                        </li>
                    ))}
...
export default function SafetyGuidelinesPage() {
    return (
        <div className="flex flex-col items-center bg-[#111111] min-h-screen w-full pt-[8.33vw] font-['SF_Pro_Text',sans-serif]">
            {/* Legend for calculated vw values (1920px ref):
                56px = 2.92vw (Header Gap) -> Handled by padding-top ~8.33vw to clear header+gap
                80px = 4.17vw (Hero Bottom Margin)
                64px = 3.33vw (Between Points)
                120px = 6.25vw (Footer Margin/Padding-bottom)
